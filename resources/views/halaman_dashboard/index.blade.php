...
<head>
    ...
    <title>Donasi Kita - Dashboard</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/admin">
                ...
                <div class="sidebar-brand-text mx-3">Admin Donasi Kita</div>
            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Donasi Kita 2024</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script src="{{asset('halaman_dashboard/js/demo/chart-pie-demo.js')}}"></script>
        ...
        <!-- Page level plugins -->
        <script src="{{asset('halaman_dahboard/vendor/datatables/jquery.dataTables.min.js')}}"></script>
        <script src="{{asset('halaman_dahboard/vendor/datatables/dataTables.bootstrap4.min.js')}}"></script>

        <!-- Page level custom scripts -->
        <script src="{{asset('halaman_dahboard/js/demo/datatables-demo.js')}}"></script>
